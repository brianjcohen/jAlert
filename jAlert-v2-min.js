...
/* 
	...
	MIT Licensed
*/
$(function(){var positionAlert=function(thisAlert){thisAlert=thisAlert.find('.jAlert');var divHeight=thisAlert.innerHeight();var winHeight=$(window).height();if(winHeight<500){var margin=20;}else{var margin=100;}
thisAlert.css('margin-top',margin+'px');winHeight=winHeight-margin;if(divHeight>winHeight){$('html, body').animate({scrollTop:0},'fast');thisAlert.closest('.jAlertWrap').css('position','absolute');}else{thisAlert.closest('.jAlertWrap').css('position','fixed');}};(function($){$('body').append("<div id='jAlertBack'></div>");$jAlertBack=$('#jAlertBack');$.fn.jAlert=function(options){var alert=this;if(alert.length>1){alert.each(function(){$(this).jAlert(options)});return this;}
